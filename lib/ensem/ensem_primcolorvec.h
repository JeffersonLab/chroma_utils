// -*- C++ -*-
// $Id: ensem_primcolorvec.h,v 2.1 2009/10/27 02:11:14 edwards Exp $
...
#ifndef ENSEM_PRIMCOLORVEC_H
#define ENSEM_PRIMCOLORVEC_H
...
template<class T, int N>
struct EnsemScalar<PColorVector<T,N> > {
  typedef PColorVector<typename EnsemScalar<T>::Type_t, N>  Type_t;
};
