// -*- C++ -*-
// $Id: operators.h,v 2.0 2008/12/05 04:43:48 edwards Exp $
...
namespace FF
{
  ...
  public:
    ...
    virtual std::vector< Handle< WaveFunction<T> > > overlaps() const = 0;
  };
  ...
  public:
    ...
    //! The allowed wavefunction overlaps 
    std::vector< Handle< WaveFunction<Complex> > > overlaps() const;
