// $Id: operators.cc,v 2.0 2008/12/05 04:43:48 edwards Exp $
/*! \file
...
//      write(xml, "OperatorType", operator_type);
  ...
  // Construct (Gamma(0)) operator
  std::vector< Handle< WaveFunction<Complex> > > 
  MesGamma0Operator::overlaps() const
  {
    std::vector< Handle< WaveFunction<Complex> > > wvf;
  ...
  { 
	...
	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma0"),
									  mesGamma0Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma1"),
									  mesGamma1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma2"),
									  mesGamma2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma3"),
									  mesGamma3Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma4"),
									  mesGamma4Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma5"),
									  mesGamma5Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma6"),
									  mesGamma6Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma7"),
									  mesGamma7Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma8"),
									  mesGamma8Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma9"),
									  mesGamma9Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma10"),
									  mesGamma10Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma11"),
									  mesGamma11Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma12"),
									  mesGamma12Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma13"),
									  mesGamma13Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma14"),
									  mesGamma14Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("Gamma15"),
									  mesGamma15Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a0"),
									  mesA0A1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("pion"),
									  mesPionA1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rho"),
									  mesRhoT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1"),
									  mesA1T1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1"),
									  mesB1T1Operator);


	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("pionxNABLA_T1"),
									  mesPionxNablaT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a0xNABLA_T1"),
									  mesA0xNablaT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b0xNABLA_T1"),
									  mesA02xNablaT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxNABLA_A1"),
									  mesRhoxNablaA1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxNABLA_T1"),
									  mesRhoxNablaT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxNABLA_T2"),
									  mesRhoxNablaT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxNABLA_E"),
									  mesRhoxNablaEOperator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xNABLA_A1"),
									  mesA1xNablaA1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xNABLA_T1"),
									  mesA1xNablaT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xNABLA_T2"),
									  mesA1xNablaT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xNABLA_E"),
									  mesA1xNablaEOperator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xNABLA_A1"),
									  mesB1xNablaA1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xNABLA_T1"),
									  mesB1xNablaT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xNABLA_T2"),
									  mesB1xNablaT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xNABLA_E"),
									  mesB1xNablaEOperator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b0xD_T2"),
									  mesA02xDT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xD_A2"),
									  mesA1xDA2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xD_E"),
									  mesA1xDEOperator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xD_T1"),
									  mesA1xDT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xD_T2"),
									  mesA1xDT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xD_A2"),
									  mesB1xDA2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xD_E"),
									  mesB1xDEOperator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xD_T1"),
									  mesB1xDT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b1xD_T2"),
									  mesB1xDT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxD_A2"),
									  mesRhoxDA2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxD_T1"),
									  mesRhoxDT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxD_T2"),
									  mesRhoxDT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxD_E"),
									  mesRhoxDEOperator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("pion_2xD_T2"),
									  mesPion2xDT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("pionxD_T2"),
									  mesPionxDT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a0xD_T2"),
									  mesA0xDT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a0xB_T1"),
									  mesA0xBT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("pionxB_T1"),
									  mesPionxBT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("b0xB_T1"),
									  mesA02xBT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxB_A1"),
									  mesRhoxBA1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxB_T1"),
									  mesRhoxBT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxB_T2"),
									  mesRhoxBT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("rhoxB_E"),
									  mesRhoxBEOperator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xB_A1"),
									  mesA1xBA1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xB_T1"),
									  mesA1xBT1Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xB_T2"),
									  mesA1xBT2Operator);

	success &= FF::TheMesonOperatorFactory::Instance().registerObject(std::string("a1xB_E"),
									  mesA1xBEOperator);
